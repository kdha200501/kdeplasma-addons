...
KWin.TabBoxSwitcher {
    ...
    component BigIconsDialog: PlasmaCore.Dialog {
        ...
        mainItem: ColumnLayout {
            ...
            width: Math.min(icons.implicitWidth + icons.delegateWidth * 0.4, tabBox.screenGeometry.width * 0.9)
            ...
            property int gridViewWidth: Math.max(1, actualItemsPerRow) * icons.delegateWidth
            ...
            GridView {
                ...
                implicitWidth: Math.max(1, dialogMainItem.actualItemsPerRow) * delegateWidth
                implicitHeight: dialogMainItem.gridViewHeight
                Layout.alignment: Qt.AlignHCenter
                Layout.leftMargin: delegateWidth * 0.1
                Layout.rightMargin: delegateWidth * 0.2
            ...
            Item {
                ...
                PlasmaComponents3.Label {
                    id: captionLabel
                    text: icons.currentItem?.appName ?? ""
                    ...
                    x: {
                        if (!icons.currentItem) return icons.x + icons.width / 2 - width / 2;
